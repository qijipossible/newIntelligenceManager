...
public class Vector
{
    ...
    public Vector(String string){
        ...
        elementArray = new float[s.length];
        for (int i = 0; i < s.length; i++) {
            elementArray[i] = Float.parseFloat(s[i]);
        }
    }
    ...
    public String toString() {
        ...
        for (float anElement : elementArray) {
            s.append(Float.toString(anElement));
            s.append("&");
        }
